...
const MultiplyAnswerStat = ({ question, setUpdateState }: { question?: any; setUpdateState: (e: boolean) => void }) => {
  if (!question) {
    return null;
  }
              ...
              <div className={styles.countAnswerWrapper}>
                <span
                  className={cn(styles.countAnswer, {
                    [styles.rightAnswer]: question?.settings?.right_answer?.includes(index),
                  })}
                >
...
export default MultiplyAnswerStat;
