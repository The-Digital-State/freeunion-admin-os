...
import { Box, Button, Grid, Link, MenuItem, Select, TextField, Typography } from '@material-ui/core';
    ...
    <form onSubmit={handleSubmit}>
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <TextField fullWidth name="email" type="email" required variant="outlined" />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography color="textPrimary" sx={{ mb: 1 }} variant="subtitle2">
            Phone Number *
          </Typography>
          <TextField fullWidth name="phone" required type="tel" variant="outlined" />
        </Grid>
        <Grid item xs={12} sm={6}>
          <Typography color="textPrimary" sx={{ mb: 1 }} variant="subtitle2">
            Company Size
        ...
        <Grid item xs={12}>
          ...
          <TextField fullWidth name="message" required multiline rows={6} variant="outlined" />
        </Grid>
      </Grid>
      <Box
        sx={{
