...
const KnowledgeBasePageTabLayout = ({ children }: React.PropsWithChildren<{}>) => {
  ...
  const tabs: { label: string; href: string }[] = [
    {
      label: 'Разделы',
      href: routes.kbase.getLinkCreateKbase(organizationId),
    },
    {
      label: 'Статьи',
      href: routes.kbase.getLinkMaterials(organizationId),
    },
    {
      label: 'Черновики',
      href: routes.kbase.getLinkDraftMaterials(organizationId),
    },
  ];
